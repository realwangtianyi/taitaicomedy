            ...
            <div className="flex justify-between pb-4 md:pb-0 md:border-b md:border-gray-200 md:justify-start">
              <NextLink href="/">
                <a className="text-sm font-light tracking-wide uppercase md:text-base lg:text-xl">
                  Taiai<span className="font-bold">Comedy</span>
                </a>
              </NextLink>
              <MobileNavButton
              ...
              {transitions.length > 0 && (
                ...
                >
                  ...
                  >
                    ...
                    {[
                      { label: "软件作品", url: "/developing" },
                      { label: "喜剧作品", url: "/comedy" },
                      { label: "文章 & 访谈", url: "/developing" },
                      { label: "阅读 & 观影", url: "/developing" },
                      { label: "首页", url: "/" },
                    ].map((link, i) => (
                      <div
...
function DesktopNav() {
  return (
    <div className="items-center hidden ml-auto md:flex">
      <DesktopNavLink to="/">首页</DesktopNavLink>
      <DesktopNavLink to="/developing">软件作品</DesktopNavLink>
      <DesktopNavLink to="/comedy">喜剧作品</DesktopNavLink>
      <DesktopNavLink to="/developing">文章 & 访谈</DesktopNavLink>
      <DesktopNavLink to="/developing">阅读 & 观影</DesktopNavLink>
